...
export interface IPortkeyWalletAttributeV1 {
...
type ProviderInfo = {
  name: string;
  accounts: Accounts;
  networkType: TNetworkTypeV1 | 'MAINNET'; // TODO
};

export interface IPortkeyWalletV1 extends IPortkeyWalletAttributeV1 {
  init: (props: PortkeyWalletOptionsV1) => Promise<void>;
  setProvider: (provider: IPortkeyProvider) => void;
  setMatchNetworkType: (networkType: TNetworkTypeV1) => void;
  /**
...
export interface PortkeyWalletOptionsV1 {
  networkType: TNetworkTypeV1;
}

class PortkeyWallet implements IPortkeyWalletV1 {
  public provider?: IPortkeyProvider;
  public matchNetworkType?: TNetworkTypeV1;
  ...
  public async init({ networkType }: PortkeyWalletOptionsV1) {
  ...
  public setMatchNetworkType(networkType: TNetworkTypeV1) {
  ...
  public refreshCaHash: (count?: number) => Promise<GetCAHolderByManagerResult> = async (
    ...
    try {
      ...
      const res = await PortkeyDidV1.did.services.getHolderInfoByManager({
